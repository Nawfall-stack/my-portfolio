...
export function Project() {
  const Projects = [
    {
      image: "/project-image/design.jpg",
      title: "Creative AI Branding",
      subtitle: "Design & Motion",
      description:
        "Modern branding design enhanced with AI, from concept to motion graphics.",
      badge: ["figma", "jitter", "canva"],
    },
    {
      ...
      description:
        "A scalable and responsive full-stack web application built with Next.js and TailwindCSS.",
    ...
    },
    {
      ...
      subtitle: "Stats & Data",
      description:
        "A comprehensive data analysis and visualization project using statistical software to derive insights.",
      badge: ["R", "SPSS"],
    },
  ];
  return (
    <div
      className="w-full max-w-6xl px-4 md:px-6 mx-auto py-12 flex flex-col gap-8"
      id="featured-project"
    >
