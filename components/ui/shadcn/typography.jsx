...
export function TypographyH1({ children, className }) {
  return (
    <h1
      className={cn(
        "text-foreground leading-tighter text-4xl font-semibold tracking-tight text-balance lg:leading-[1.1] lg:font-semibold xl:text-5xl xl:tracking-tighter max-w-4xl",
        className,
      )}
    >
      {children}
...
export function TypographyP({ children, className }) {
  return (
    <p
      className={cn(
        "text-foreground text-center max-w-2xl text-base text-balance xs:text-lg",
        className,
      )}
    >
      {children}
